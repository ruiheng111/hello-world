...
ABSTRACT = (
    "摘要：本文比较分析1997年亚洲金融危机与2010—2018年欧元区主权债务危机，"
    "考察二者在脆弱性积累、冲击传导、恐慌扩散与政策应对四个维度的机制异同，"
    "并将其与美国1907年银行恐慌、1929—1933年大萧条及2007—2009年全球金融危机"
    "置于同一历史脉络中加以对照。研究目的并非罗列事件，而是识别在不同制度"
    "条件下反复出现的金融危机演化逻辑，以及两场当代危机各自特有的结构性约束。"
    "两场危机均发生在金融深化与跨境资本流动加速的阶段。亚洲方面，高增长与"
    "外部融资相互嵌套，固定汇率稳定了外资流入预期，却在繁荣期系统性地低估"
    "了短期外债、房地产关联授信及企业外币负债所累积的货币错配与期限错配；"
    "冲击由泰铢失守迅速传导至银行资产负债表，并在区域资本流动同步重定价下"
    "外溢。欧元区方面，单一货币消除了区内汇率波动，却未伴随充分的财政协调"
    "与共同金融稳定支持；利率收敛刺激跨境银行敞口扩张，内部竞争力分化在"
    "缺乏名义汇率调节工具的情况下持续积累，最终使希腊等国的财政问题演变为"
    "具有“主权—银行”反馈特征的区域性危机。政策应对的比较进一步显示，"
    "恢复信心、提供流动性并及时阻断亏损源，是历次危机治理的共同核心，但"
    "可用工具高度依赖制度环境。亚洲危机更多依靠放弃不可持续的钉住安排、"
    "IMF牵头官方融资、关闭或重组问题机构以及扩展存款担保；马来西亚的"
    "资本管制则表明，在极端恐慌下资本流动管理亦可能构成稳定政策的一环。"
    "欧元区则经历了从前期财政紧缩、EFSF/ESM区域救助，到2012年OMT承诺及"
    "此后大规模资产购买、银行业联盟建设的渐进演进，试图在缺乏统一最后贷款人"
    "的条件下重建预期锚。跨案例比较表明，重大金融危机虽形态各异，却共享"
    "相近的演化链条：繁荣期脆弱性被低估并持续积累，局部冲击触发资产与负债"
    "的同步重定价，恐慌沿银行间或跨境融资网络扩散，最终放大为实体衰退。"
    "1907年恐慌、大萧条与全球金融危机为理解当代两场危机提供了历史参照；"
    "亚洲危机与欧元区危机则进一步说明，当脆弱性嵌入固定汇率、短期外债或"
    "不完备货币联盟安排时，冲击会更早地转化为货币、主权与银行之间的联动。"
    "对政策而言，这意味着金融开放与一体化必须与监管能力、信息披露和危机"
    "处置框架同步推进；能否有效打断负向反馈，不取决于能否复制某一历史案例，"
    "而取决于能否在特定制度约束下同时实现预期稳定、损失分担与激励约束的平衡。"
)

KEYWORDS = (
    "关键词：金融脆弱性；金融自由化；货币危机；主权债务危机；最后贷款人；传染"
)
