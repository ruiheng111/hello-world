...
ABSTRACT = (
    ...
    "考察二者在脆弱性积累、冲击传导、恐慌扩散与政策应对方面的机制异同，并将其"
    "与美国1907年银行恐慌、1929—1933年大萧条及2007—2009年全球金融危机"
    "置于同一历史脉络中对照。两场危机均发生在金融深化与跨境资本流动加速的背景下，"
    "但嵌入的制度约束不同：亚洲危机突出固定汇率、短期外债攀升及银行体系货币错配"
    "与期限错配的相互强化；欧元区危机则体现为不完备货币联盟下“统一货币—分散财政”"
    "的结构矛盾，以及主权信用重定价与本国银行资产负债表之间的负向反馈。政策应对上，"
    "二者均凸显最后贷款人、问题机构处置、存款与融资稳定机制及预期管理的关键作用，"
    "但亚洲更多依赖汇率调整、IMF框架下的官方融资与各国差异化的银行重组，欧元区则"
    "经历从财政紧缩到EFSF/ESM区域救助、2012年OMT承诺及此后量化宽松和银行业"
    "联盟建设的渐进补建。跨案例比较表明，重大金融危机虽形态各异，却反复呈现"
    "“繁荣期脆弱性积累—局部冲击触发重定价—恐慌沿融资网络扩散—实体衰退加深”的"
    "演化链条；识别并打断负向反馈环，比简单复制某一历史案例的政策模板更为根本。"
)
